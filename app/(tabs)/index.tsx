...
const styles = StyleSheet.create({
  splashContainer: {
    ...
    ...(Platform.OS === 'web' && {
      backgroundImage: 'linear-gradient(135deg, rgba(255, 26, 26, 0.95) 0%, rgba(255, 26, 26, 0.6) 25%, rgba(255, 26, 26, 0.2) 60%, rgba(0, 0, 0, 0.9) 85%, rgba(0, 0, 0, 1) 100%)',
    }),
  },
  splashContent: {
    flex: 1,
  ...
  gradientOverlay: {
    ...
    ...(Platform.OS === 'web' && {
      backgroundImage: 'linear-gradient(135deg, rgba(255, 26, 26, 0.8) 0%, rgba(255, 26, 26, 0.4) 20%, rgba(255, 26, 26, 0.1) 50%, rgba(0, 0, 0, 0.8) 80%, rgba(0, 0, 0, 0.95) 100%)',
