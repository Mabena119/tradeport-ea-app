...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, Platform.OS === 'web' && { backgroundImage: glassMode === 'neon' ? 'linear-gradient(135deg, rgba(' + theme.accentRgb + ', 0.9) 0%, rgba(' + theme.accentRgb + ', 0.5) 30%, rgba(' + theme.accentRgb + ', 0.1) 65%, rgba(0,0,0,0.95) 90%, #000 100%)' : glassMode === 'liquid' ? 'linear-gradient(160deg, #2a2a2e 0%, #1c1c1e 30%, #141416 60%, #0e0e10 100%)' : glassMode === 'commander' ? 'linear-gradient(170deg, rgba(30,10,10,0.6) 0%, #050505 40%, #000 100%)' : 'linear-gradient(160deg, rgba(' + theme.accentRgb + ', 0.08) 0%, #050505 40%, #000 100%)' }]}>
